# Benchmark Státusz Táblázat — 2026-07-13. 12:36 CEST

**Utolsó frissítés:** 2026-07-13. 12:36 CEST — UD refuttatás fut (minimax-m3-nothink, 60/449)
...
| gpt-oss-120b-cloud | nothink | 71.79% | 85.67% | 8.7% (122) | 50% (W0/L0/T0) | 0.0% (U0/0/0) |
...
| minimax-m3-cloud | nothink | 75.78% | 91.33% | 9.4% (291) | 50% (W0/L0/T0) | 14% (66/449) |
...
| Benchmark | Összes | Kész | Hátralévő | Átlag futásidő (24ó outlier-szűrés) | Megjegyzés |
|-----------|--------|------|-----------|-------------------------------------|-----------|
| hulu | 56782 | 56782 | 0 | 4ó 27p | ✅ kész (22/22 modell) |
| mmlu_hu | 33000 | 30000 | 3000 | 3ó 34p | 20/22 modell kész |
| hugme | 6578 | 5980 | 598 | 1ó 48p | ✅ bíró rejudge kész |
| mt_bench_hu | 528 | 480 | 48 | 0ó 23p | ✅ bíró rejudge kész (multi-baseline) |
| ud_hungarian | 9878 | 8531 | 1347 | 0ó 55p | 🔄 refuttatás fut (2/3 nothink kész, 0/10 think) |

## UD futásidők (részletes, 24ó outlier-szűrés után)

- `deepseek-v4-flash-cloud-nothink`: 0ó 34p
- `deepseek-v4-flash-cloud-think`: 0ó 34p
- `deepseek-v4-pro-cloud-nothink`: 0ó 37p
- `deepseek-v4-pro-cloud-think`: 0ó 39p
- `glm-5.1-cloud-nothink`: 0ó 36p
- `glm-5.1-cloud-think`: 0ó 36p
- `glm-5.2-cloud-nothink`: 0ó 47p
- `glm-5.2-cloud-think`: 0ó 46p
- `gpt-oss-120b-cloud-nothink`: 1ó 50p
- `gpt-oss-120b-cloud-think`: 0ó 34p
- `gpt-oss-20b-cloud-nothink`: 1ó 20p
- `gpt-oss-20b-cloud-think`: 0ó 54p
- `kimi-k2.6-cloud-nothink`: 0ó 37p
- `kimi-k2.6-cloud-think`: 0ó 36p
- `minimax-m3-cloud-think`: 0ó 37p
- `nemotron-3-ultra-cloud-nothink`: 124ó 36p
- `nemotron-3-ultra-cloud-think`: 3ó 0p
- `qwen3.5-cloud-nothink`: 0ó 56p
- `qwen3.5-cloud-think`: 0ó 53p
...
## Aktuális állapot (2026-07-13. 12:36 CEST)

**Futó folyamat:**
- `run_ud_hungarian.py --model minimax-m3-cloud --mode nothink --reset` — 60/449 (13.3%)

**Befejezett fázisok:**
- ✅ HuGME rejudge: 2026-07-13. 06:31 (~21ó futásidő)
- ✅ MT-Bench rejudge: 2026-07-13. 07:00 (~29p futásidő)
- ✅ UD nothink refuttatás: gpt-oss:120b (1ó50p), gpt-oss:20b (1ó20p) kész

## Becsült teljes befejezés

**UD refuttatás hátralévő:**
- minimax-m3-cloud-nothink: 60/449 (13.3%), 14p eltelt → ~85p hátralévő → ~13:00-13:15 CEST kész
- 10 think modell × ~40-55p/modell = 6.7-9.2 ó → 19:00-22:00 CEST kész

**Becsült teljes UD refuttatás kész:** 2026-07-13. ~19:00-22:00 CEST
**3 nap határidő (gemini-3-flash-preview megszűnése):** 2026-07-14. 09:00 CEST
**Tartalék:** ~11-14 ó
