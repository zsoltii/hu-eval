...
| Értékelt modellek | 10 aktív + qwen3-next-80b-cloud RETIRED |
| Operator | openclaw |
...
> **Bíró modell** (LLM-as-a-Judge): `gemini-3-flash-preview:latest` — 2026-07-14. 09:00 CEST óta nem elérhető (Ollama megszűnés). A HuGME és MT-Bench-HU eredmények nem reprodukálhatóak; új bíró modell (pl. `gemini-3-pro-preview`) szükséges a jövőbeli futtatásokhoz.
...
- 🥇 **Legjobb HuGME (judge score):** deepseek-v4-pro-cloud (nothink) — 9.8%
...
**Legrosszabb aktív:** gpt-oss-20b-cloud (nothink) — 67.0%
...
| **glm-5.2-cloud (nothink)** | — | — | — | — | — | — | **70.6%** * |
| **glm-5.2-cloud (think)** | — | — | — | — | — | — | **72.2%** * |

> `*` **glm-5.2-cloud:** a per-sub-task bontás nem áll rendelkezésre a `hulu-breakdown` aggregációkban (csak az egyesített overall eredmény: nothink 75.3%, think 76.0%). A composite oszlopban az overall érték szerepel helyettesítésként.
...
- 🥇 **Generatív (HuGME + MT-Bench átlaga):** deepseek-v4-pro-cloud (nothink) — 29.9%
- 🥇 **Nyelvészeti (UD composite):** deepseek-v4-flash-cloud (nothink) — 69.9%
- 🏆 **Composite győztes (40/40/20):** deepseek-v4-pro-cloud (nothink) — 54.3%
...
- **think modellek UD 0-7.5%** — CoT-strip probléma, a parser a CoNLL-U-t a válasz végén keresi, de a modellek gondolkodnak. Kivétel: nemotron-3-ultra-think 7.5% (a legjobb think UD).
...
- **HuGME ↔ MT-Bench-HU:** nincs korreláció (HuGME differenciál 8.2-9.8%, MT-Bench mind 50%).

### Limitációk

- **Bíró modell (gemini-3-flash-preview) megszűnt 2026-07-14. 09:00 CEST** — a HuGME és MT-Bench-HU eredmények nem lesznek reprodukálhatóak; új bíró modell (gemini-3-pro vagy más) kell.
...
- **Összehasonlíthatóság** — minden modell cloud (Ollama cloud), lokális összehasonlítás nem készült.
...
|-------|--------|----------|
| 2026-07-10 | openclaw | UD parser CoT-aware átírás (16 cella 0.0% javítva) |
| 2026-07-10 | openclaw | HuLU dedup (4 modell, 200 duplikátum törölve: qwen3.5-nothink 112, qwen3.5-think 29, gpt-oss:120b-nothink 19, nemotron-think 40) |
| 2026-07-10 | openclaw | MMLU parser javítás (think-block strip + magyar szöveges leírások) |
| 2026-07-10 | openclaw | gpt-oss:20b HuLU 27ó 43p, accuracy 71.41% |
| 2026-07-10 | openclaw | nemotron-3-ultra MMLU 5ó 14p, accuracy 91.73% (javított parser) |
| 2026-07-13 | openclaw | HuGME rejudge 21ó, 22 modell × 300 item × 6 metrika (gemini-3-flash-preview bíró) |
| 2026-07-13 | openclaw | MT-Bench rejudge multi-baseline 29p, 20 modell × 24 item × 3 baseline |
| 2026-07-13/14 | openclaw | UD refuttatás 13 modell CoT-aware parser-rel, ~32ó (3 nothink + 10 think) |
| 2026-07-14 | openclaw | Queue kész 20:14 CEST, `priority_judge.sh` kilépett, `priority_ud_done` marker fájl írva |
| 2026-07-15 | openclaw | Végleges riport legyártva (`report-2026-07-14.md`), 2 heatmap + composite CSV, template és runbook frissítve |
